...
export const Route = createFileRoute("/book-consultation")({
  ...
  head: () => ({
    meta: [
      { title: "Book Consultation — PSCyberCore" },
      { name: "description", content: "Book a consultation with PSCyberCore experts. Let us understand your business and design the right technology solution." },
    ],
  }),
});
